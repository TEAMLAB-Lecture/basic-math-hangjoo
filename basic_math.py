...
def get_median(number_list):
    ...
    pivot = len(sorted_number_list) // 2
    median = None
    if pivot == len(sorted_number_list) / 2:
        median = (sorted_number_list[pivot] + sorted_number_list[pivot - 1]) / 2
    else:
        median = sorted_number_list[pivot]
    return median
